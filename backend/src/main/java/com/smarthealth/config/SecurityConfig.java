...
import com.smarthealth.security.JwtAuthenticationEntryPoint;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/states/**", "/api/districts/**", "/api/mandals/**", "/api/villages/**", "/api/map-locations/**").permitAll()
